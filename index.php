...
<body>
    <div class="col-12 bg-black text-white d-flex justify-content-between" id="header">
        <img src="/icon/logo_imperfecto.png" alt="" style="width:7em;">
        <h3>Pasitos de &aacute;ngel</h3>
        <a href="">Sistema</a>
    </div>
